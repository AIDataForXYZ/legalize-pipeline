...
REGISTRY: dict[str, dict[str, tuple[str, str]]] = {
    ...
    "co": {
        "client": ("legalize.fetcher.co.client", "SuinClient"),
        "discovery": ("legalize.fetcher.co.discovery", "SuinDiscovery"),
        "text_parser": ("legalize.fetcher.co.parser", "SuinTextParser"),
        "metadata_parser": ("legalize.fetcher.co.parser", "SuinMetadataParser"),
    },
    "lt": {
    ...
    "mx": {
        "client": ("legalize.fetcher.mx.client", "MXClient"),
        "discovery": ("legalize.fetcher.mx.discovery", "MXDiscovery"),
        "text_parser": ("legalize.fetcher.mx.parser", "MXTextParser"),
        "metadata_parser": ("legalize.fetcher.mx.parser", "MXMetadataParser"),
    },
    # To add a new country:
    # 1. Create fetcher/{code}/ with client.py, discovery.py, parser.py
    # 2. Register here
